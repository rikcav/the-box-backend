...
export const getAll = async (req: express.Request, res: express.Response) => {
  try {
    ...
    res
      .status(400)
      .send({ message: `Could not get event schedules`, error: error });
  }
};
...
export const getByScheduleId = async (
  ...
  try {
    ...
    res.status(404).send({
      message: `Could not get event schedules by schedule id`,
      error: error,
    });
  }
};
...
export const get = async (req: express.Request, res: express.Response) => {
  try {
    ...
    res
      .status(404)
      .send({ message: `Could not get event schedule`, error: error });
  }
};
...
export const create = async (req: express.Request, res: express.Response) => {
  try {
    ...
    res
      .status(400)
      .send({ message: `Could not create event schedule`, error: error });
  }
};
